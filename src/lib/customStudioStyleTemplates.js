export const GDP_STYLE_TEMPLATES = [
  ...
  {
    id: "memorial-crimson-eternal",
    name: "Crimson Eternal",
    description: "Silver-and-crimson remembrance frame with white doves, crosses, red roses and a dramatic portrait opening.",
    category: "memorial_tribute",
    thumbnail: "/images/gdp-styles/memorial-crimson-eternal.avif",
    fullAsset: "/images/gdp-styles/memorial-crimson-eternal.avif",
    assetUrl: "/images/gdp-styles/memorial-crimson-eternal.avif",
    active: true,
    enabled: true,
    sortOrder: 110,
    locked: true,
    photoZone: { x: 19, y: 18, width: 62, height: 60, shape: "oval", radius: 16 },
    textZone: { x: 15, y: 79, width: 70, height: 14, align: "center", tone: "light" },
    defaultTransform: { scale: 100, rotation: 0, offset: { x: 0, y: 0 }, fitMode: "fit" },
  },
  {
    id: "memorial-golden-grace",
    name: "Golden Grace",
    description: "Black-and-gold memorial frame with a radiant cross, white doves, candles and ivory roses.",
    category: "memorial_tribute",
    thumbnail: "/images/gdp-styles/memorial-golden-grace.avif",
    fullAsset: "/images/gdp-styles/memorial-golden-grace.avif",
    assetUrl: "/images/gdp-styles/memorial-golden-grace.avif",
    active: true,
    enabled: true,
    sortOrder: 120,
    locked: true,
    photoZone: { x: 20, y: 19, width: 60, height: 56, shape: "oval", radius: 18 },
    textZone: { x: 14, y: 80, width: 72, height: 13, align: "center", tone: "light" },
    defaultTransform: { scale: 100, rotation: 0, offset: { x: 0, y: 0 }, fitMode: "fit" },
  },
  {
    id: "memorial-heavens-horizon",
    name: "Heaven’s Horizon",
    description: "Luminous blue cloud-and-lily tribute with white doves, sun rays and a peaceful ocean horizon.",
    category: "memorial_tribute",
    thumbnail: "/images/gdp-styles/memorial-heavens-horizon.avif",
    fullAsset: "/images/gdp-styles/memorial-heavens-horizon.avif",
    assetUrl: "/images/gdp-styles/memorial-heavens-horizon.avif",
    active: true,
    enabled: true,
    sortOrder: 130,
    locked: true,
    photoZone: { x: 23, y: 22, width: 54, height: 50, shape: "rounded", radius: 14 },
    textZone: { x: 15, y: 80, width: 70, height: 13, align: "center", tone: "light" },
    defaultTransform: { scale: 100, rotation: 0, offset: { x: 0, y: 0 }, fitMode: "fit" },
  },
  {
    id: "memorial-everlasting-bloom",
    name: "Everlasting Bloom",
    description: "Elegant white lily-and-rose frame with pearls, soft blue flowers, eucalyptus and satin ribbon accents.",
    category: "memorial_tribute",
    thumbnail: "/images/gdp-styles/memorial-everlasting-bloom.avif",
    fullAsset: "/images/gdp-styles/memorial-everlasting-bloom.avif",
    assetUrl: "/images/gdp-styles/memorial-everlasting-bloom.avif",
    active: true,
    enabled: true,
    sortOrder: 140,
    locked: true,
    photoZone: { x: 23, y: 18, width: 54, height: 58, shape: "rounded", radius: 14 },
    textZone: { x: 15, y: 81, width: 70, height: 12, align: "center", tone: "light" },
    defaultTransform: { scale: 100, rotation: 0, offset: { x: 0, y: 0 }, fitMode: "fit" },
  },
  {
    id: "memorial-angels-embrace",
    name: "Angel’s Embrace",
    description: "White-and-gold angel-wing tribute with a radiant halo, clouds, doves, lilies and ornate gold details.",
    category: "memorial_tribute",
    thumbnail: "/images/gdp-styles/memorial-angels-embrace.avif",
    fullAsset: "/images/gdp-styles/memorial-angels-embrace.avif",
    assetUrl: "/images/gdp-styles/memorial-angels-embrace.avif",
    active: true,
    enabled: true,
    sortOrder: 150,
    locked: true,
    photoZone: { x: 23, y: 24, width: 54, height: 50, shape: "rounded", radius: 16 },
    textZone: { x: 14, y: 80, width: 72, height: 13, align: "center", tone: "light" },
    defaultTransform: { scale: 100, rotation: 0, offset: { x: 0, y: 0 }, fitMode: "fit" },
  },
];
...
export function normalizeStyleTemplates(overrides = {}) {
  ...
  return GDP_STYLE_TEMPLATES.map((base) => {
    ...
    return {
      ...
      category: base.category || "photo_bootleg",
  ...
  return Object.fromEntries(
    templates.map((item) => [
      item.id,
      {
        ...
        category: item.category || "photo_bootleg",
