...
assert.ok(!/CustomStudioDesktopWorkspaceV(?:8|9|10|11|12|13)/.test(app), 'App must not route through the retired V8-V13 wrapper chain.');
...
assert.ok(workspace.includes('.gdp-custom-studio-v7 [data-studio-row]'), 'Guide-aware workspace sizing must apply to all main Studio steps.');
